...
/*The java bean is a java class, that has a private
attribute, and public setter and getter. The idea behind java bean, is 
to allow us to represent the database table,
 and each java bean object is considered as a table row.
*/
